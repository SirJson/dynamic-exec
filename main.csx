...
public class Shell : DynamicObject {
    ...
    private readonly bool noEcho;
    private readonly string windowsName;
    private readonly string windowsArgs;
    private readonly string echoPrefix;
    private readonly Action<IDictionary<string, string>> configureEnvironment;
